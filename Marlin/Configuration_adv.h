...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.66    // Unit: mm compression per 1mm/s extruder speed
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       600        //800amg (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #define X_HYBRID_THRESHOLD     150  // 120amg [mm/s]
  ...
  #define E1_HYBRID_THRESHOLD     10 //20amg
